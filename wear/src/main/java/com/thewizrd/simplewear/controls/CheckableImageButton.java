...
public class CheckableImageButton extends AppCompatImageButton implements Checkable {
    ...
    public void setChecked(boolean checked, boolean raiseEvent) {
        if (checkable && this.checked != checked) {
            this.checked = checked;
            refreshDrawableState();
            if (raiseEvent && mOnCheckedChangeListener != null) {
     ...
     */
    public void setOnCheckedChangeListener(@androidx.annotation.Nullable OnCheckedChangeListener listener) {
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        CheckableImageButton.SavedState savedState = new CheckableImageButton.SavedState(superState);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        CheckableImageButton.SavedState savedState = (CheckableImageButton.SavedState) state;
    ...
    static class SavedState extends AbsSavedState {
        ...
        public static final Creator<CheckableImageButton.SavedState> CREATOR =
                new ClassLoaderCreator<CheckableImageButton.SavedState>() {
                    @NonNull
                    @Override
                    public CheckableImageButton.SavedState createFromParcel(@NonNull Parcel in, ClassLoader loader) {
                        return new CheckableImageButton.SavedState(in, loader);
                    }

                    @NonNull
                    @Override
                    public CheckableImageButton.SavedState createFromParcel(@NonNull Parcel in) {
