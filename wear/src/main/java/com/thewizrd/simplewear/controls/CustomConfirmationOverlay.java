 ...
 * </pre>
 */
public class CustomConfirmationOverlay {

    /**
     * Interface for listeners to be notified when the {@link CustomConfirmationOverlay} animation has
    ...
    /**
     * {@link OverlayType} indicating a custom animation overlay should be displayed.
     */
    public static final int CUSTOM_ANIMATION = 3;
     ...
     */
    public CustomConfirmationOverlay setMessage(String message) {
        mMessage = message;
        return this;
    }
     ...
     * @return {@code this} object for method chaining.
     */
    public CustomConfirmationOverlay setType(@OverlayType int type) {
        mType = type;
        return this;
    }
     ...
     * @return {@code this} object for method chaining.
     */
    public CustomConfirmationOverlay setDuration(int millis) {
     ...
     * @return {@code this} object for method chaining.
     */
    public CustomConfirmationOverlay setFinishedAnimationListener(
    ...
    private void updateOverlayView(Context context) {
        if (mOverlayView == null) {
            ...
            mOverlayView =
                    LayoutInflater.from(context).inflate(mType == CUSTOM_ANIMATION ?
                            com.thewizrd.simplewear.R.layout.ws_customoverlay_confirmation :
                            R.layout.ws_overlay_confirmation, null);
        }
    ...
    private void updateMessageView(Context context, View overlayView) {
        ...
        if (mMessage != null) {
            int screenWidthPx = ResourcesUtils.getScreenWidthPx(context);
            int topMarginPx = ResourcesUtils.getFractionOfScreenPx(
                    context, screenWidthPx, R.fraction.confirmation_overlay_margin_above_text);
            int sideMarginPx =
                    ResourcesUtils.getFractionOfScreenPx(
    ...
    private void updateImageView(Context context, View overlayView) {
        switch (mType) {
            ...
            case CUSTOM_ANIMATION:
                if (mCustomDrawable == null) {
                    throw new IllegalStateException("Custom drawable is invalid");
                }
                mOverlayDrawable = mCustomDrawable;
                break;
            default:
                String errorMessage =
        ...
        if (imageView.getLayoutParams() instanceof ConstraintLayout.LayoutParams) {
            ...
            if (StringUtils.isNullOrWhitespace(mMessage)) lp.verticalBias = 0.5f;
     ...
     * @return {@code this} object for method chaining.
     */
    public CustomConfirmationOverlay setCustomDrawable(Drawable customDrawable) {
